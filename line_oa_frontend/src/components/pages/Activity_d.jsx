...
import { getActivityD, getSumActivityD } from '../Functions/RichMenu'
...
function Activity_d() {
    ...
    const [sumActivityD, setSumActivityD] = useState([])
    ...
    const sum_imp_D = sumActivityD.map((item) => parseInt(item.imp_D))
    const sum_impUU_D = sumActivityD.map((item) => parseInt(item.impUU_D))
    const sum_click_D = sumActivityD.map((item) => parseInt(item.click_D))
    const sum_clickUU_D = sumActivityD.map((item) => parseInt(item.clickUU_D))
    const sum_clickUURate_D = sumActivityD.map((item) => parseFloat(item.clickUURate_D))
    ...
    const handleFilter1 = (e) => {
        ...
        setSearchQuery1(activityD.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter2 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery2(activityD.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter3 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery3(activityD.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter4 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery4(activityD.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter5 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery5(activityD.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }
    ...
    const imp_D = searchQuery1.map((item) => item.imp_D)
    const impUU_D = searchQuery2.map((item) => parseInt(item.impUU_D))
    const click_D = searchQuery3.map((item) => parseInt(item.click_D))
    const clickUU_D = searchQuery4.map((item) => parseInt(item.clickUU_D))
    const clickUURate_D = searchQuery5.map((item) => parseFloat(item.clickUURate_D))
            ...
            <Layout>
                ...
                <Layout>
                    ...
                    >
                        ...
                        <h3 className='text-center'>สถิติข้อมูล RICH MENU ใบสั่งยา/ใบสั่งแล็บ/ผลแล็บ/ใบรับรองแพทย์</h3>
                            ...
                            <div className='row' style={{ margin: '5px' }}>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_imp_D.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_impUU_D.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_click_D.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_clickUU_D.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                ...
                                <>
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนครั้งที่แสดง RICH MENU ใบสั่งยา/ใบสั่งแล็บ/ผลแล็บ/ใบรับรองแพทย์</h4>
                                                </div>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนผู้ใช้ที่มีการเข้าถึง RICH MENU ใบสั่งยา/ใบสั่งแล็บ/ผลแล็บ/ใบรับรองแพทย์</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนครั้งที่มีการคลิก RICH MENU ใบสั่งยา/ใบสั่งแล็บ/ผลแล็บ/ใบรับรองแพทย์</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนผู้ใช้ที่คลิก RICH MENU ใบสั่งยา/ใบสั่งแล็บ/ผลแล็บ/ใบรับรองแพทย์</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>อัตราการคลิก RICH MENU ใบสั่งยา/ใบสั่งแล็บ/ผลแล็บ/ใบรับรองแพทย์</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>

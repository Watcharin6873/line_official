...
import { getActivityC, getSumActivityC } from '../Functions/RichMenu'
...
function Activity_c() {
    ...
    const [sumActivityC, setSumActivityC] = useState([])
    ...
    const sum_imp_C = sumActivityC.map((item) => parseInt(item.imp_C))
    const sum_impUU_C = sumActivityC.map((item) => parseInt(item.impUU_C))
    const sum_click_C = sumActivityC.map((item) => parseInt(item.click_C))
    const sum_clickUU_C = sumActivityC.map((item) => parseInt(item.clickUU_C))
    const sum_clickUURate_C = sumActivityC.map((item) => parseFloat(item.clickUURate_C))
    ...
    const handleFilter1 = (e) => {
        ...
        setSearchQuery1(activityC.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter2 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery2(activityC.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter3 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery3(activityC.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter4 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery4(activityC.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter5 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery5(activityC.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }
    ...
    const imp_C = searchQuery1.map((item) => item.imp_C)
    const impUU_C = searchQuery2.map((item) => parseInt(item.impUU_C))
    const click_C = searchQuery3.map((item) => parseInt(item.click_C))
    const clickUU_C = searchQuery4.map((item) => parseInt(item.clickUU_C))
    const clickUURate_C = searchQuery5.map((item) => parseFloat(item.clickUURate_C))
            ...
            <Layout>
                ...
                <Layout>
                    ...
                    >
                        ...
                        <h3 className='text-center'>สถิติข้อมูล RICH MENU บริจาคดวงตา อวัยวะ</h3>
                            ...
                            <div className='row' style={{ margin: '5px' }}>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_imp_C.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_impUU_C.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_click_C.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_clickUU_C.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                ...
                                <>
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนครั้งที่แสดง RICH MENU บริจาคดวงตา อวัยวะ</h4>
                                                </div>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนผู้ใช้ที่มีการเข้าถึง RICH MENU บริจาคดวงตา อวัยวะ</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนครั้งที่มีการคลิก RICH MENU บริจาคดวงตา อวัยวะ</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนผู้ใช้ที่คลิก RICH MENU บริจาคดวงตา อวัยวะ</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>อัตราการคลิก RICH MENU บริจาคดวงตา อวัยวะ</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>

...
import { getActivityAll, getSumActivityALL } from '../Functions/RichMenu'
...
function Activity_all() {
    ...
    const [sumActivityAll, setSumActivityAll] = useState([])
    ...
    const sum_imp_ALL = sumActivityAll.map((item) => parseInt(item.imp_ALL))
    const sum_impUU_ALL = sumActivityAll.map((item) => parseInt(item.impUU_ALL))
    const sum_click_ALL = sumActivityAll.map((item) => parseInt(item.click_ALL))
    const sum_clickUU_ALL = sumActivityAll.map((item) => parseInt(item.clickUU_ALL))
    const sum_clickUURate_ALL = sumActivityAll.map((item) => parseFloat(item.clickUURate_ALL))
    ...
    const handleFilter1 = (e) => {
        ...
        setSearchQuery1(activityAll.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter2 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery2(activityAll.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter3 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery3(activityAll.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter4 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery4(activityAll.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }

    const handleFilter5 = (e) => {
        const startDate = e[0].format('YYYY-MM-DD');
        const endDate = e[1].format('YYYY-MM-DD');
        setSearchQuery5(activityAll.filter(f => f.rich_date >= startDate && f.rich_date <= endDate))
    }
    ...
    const imp_ALL = searchQuery1.map((item) => item.imp_ALL)
    const impUU_ALL = searchQuery2.map((item) => parseInt(item.impUU_ALL))
    const click_ALL = searchQuery3.map((item) => parseInt(item.click_ALL))
    const clickUU_ALL = searchQuery4.map((item) => parseInt(item.clickUU_ALL))
    const clickUURate_ALL = searchQuery5.map((item) => parseFloat(item.clickUURate_ALL))
        ...
        <>
            <Layout>
                ...
                <Layout>
                    ...
                    >
                        <h3 className='text-center'>สถิติข้อมูล RICH MENU บน LINE OA หมอพร้อม รวมทั้งหมด</h3>
                            ...
                            <div className='row' style={{ margin: '5px' }}>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_imp_ALL.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_impUU_ALL.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_click_ALL.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                    ...
                                    >
                                        ...
                                        >
                                            {sum_clickUU_ALL.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                        </h3>
                                    </div>
                                </div>
                                <div className='col'>
                                ...
                                <>
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนครั้งที่แสดง RICH MENU ทั้งหมด</h4>
                                                </div>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนผู้ใช้ที่มีการเข้าถึง RICH MENU ทั้งหมด</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนครั้งที่มีการคลิก RICH MENU ทั้งหมด</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>จำนวนผู้ใช้ที่คลิก RICH MENU ทั้งหมด</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
                                    ...
                                    <div className='row' style={{ margin: '10px' }}>
                                        <div className='card bg-white border rounded col m-1'>
                                            <div>
                                                <div>
                                                    <h4 className='text-center' style={{ margin: '10px' }}>อัตราการคลิก RICH MENU ทั้งหมด</h4>
                                                </div>
                                                <div style={{ marginRight: '40px', float: 'right' }}>
